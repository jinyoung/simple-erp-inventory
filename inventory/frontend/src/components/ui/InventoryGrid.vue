<template>
    <div style="max-height:80vh;">
        ...
        <div class="gs-bundle-of-buttons" style="max-height:10vh;">
            ...
            <v-btn @click="updateInventoryDialog = true" class="contrast-primary-text" small color="primary" :disabled="!hasRole('Admin')">
                <v-icon small>mdi-minus-circle-outline</v-icon>재고 업데이트
            </v-btn>
            <v-dialog v-model="updateInventoryDialog" width="500">
                <UpdateInventoryCommand
                    @closeDialog="updateInventoryDialog = false"
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','quantity',]" />
...
export default {
    ...
    methods:{
        updateInventory(params){
            try{
                this.repository.invoke(this.getSelectedItem(), "updateInventory", params)
                this.$EventBus.$emit('show-success','UpdateInventory 성공적으로 처리되었습니다.')
            }catch(e){
